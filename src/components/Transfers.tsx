...
import { settingsService, DEFAULT_TRANSFER_SLIP_TEMPLATE } from '../lib/settingsService';
...
export const Transfers: React.FC = () => {
  ...
  const handlePrintReceipt = async (transfer: TransferRequest, items: TransferItem[]) => {
    try {
      ...
      console.error('Failed to print custom transfer slip receipt:', err);
      // Fallback directly to printing with default template
      printTransferSlip(transfer, items, DEFAULT_TRANSFER_SLIP_TEMPLATE);
    }
  };
